(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var cache = {};
    var MonoTableInfo = /** @class */ (function () {
        function MonoTableInfo(options) {
        ...
        Object.defineProperty(MonoTableInfo.prototype, "rows", {
            get: function () {
        ...
        MonoTableInfo.fromAddress = function (address) {
            if (address.isNull())
                return null;
            var addressNumber = address.toInt32();
            if (cache[addressNumber] === undefined) {
                cache[addressNumber] = new MonoTableInfo({ address: address });
            }
    ...
    var MonoImage = /** @class */ (function () {
        ...
        MonoImage.fromAddress = function (address) {
            ...
            if (cache$1[addressNumber] === undefined) {
                cache$1[addressNumber] = new MonoImage({ address: address });
            }
    ...
    var MonoType = /** @class */ (function () {
        ...
        MonoType.fromAddress = function (address) {
            ...
            if (cache$2[addressNumber] === undefined) {
                cache$2[addressNumber] = new MonoType({ address: address });
            }
    ...
    var MonoClassField = /** @class */ (function () {
        ...
        MonoClassField.fromAddress = function (address) {
            ...
            if (cache$3[addressNumber] === undefined) {
                cache$3[addressNumber] = new MonoClassField({ address: address });
            }
    ...
    var cache$4 = {};
    var MonoVTable = /** @class */ (function () {
        function MonoVTable(options) {
            if (options === void 0) { options = {}; }
            if (options.address) {
                this.$address = options.address;
            }
        ...
        MonoVTable.fromAddress = function (address) {
            if (address.isNull())
                return null;
            var addressNumber = address.toInt32();
            if (cache$4[addressNumber] === undefined) {
                cache$4[addressNumber] = new MonoVTable({ address: address });
            }
            return cache$4[addressNumber];
        };
        return MonoVTable;
    }());

    var cache$5 = {};
    var MonoMethod = /** @class */ (function () {
        function MonoMethod(options) {
            if (options === void 0) { options = {}; }
            if (options.address) {
                this.$address = options.address;
            }
        ...
        MonoMethod.fromAddress = function (address) {
            if (address.isNull())
                return null;
            var addressNumber = address.toInt32();
            if (cache$5[addressNumber] === undefined) {
                cache$5[addressNumber] = new MonoMethod({ address: address });
            }
            return cache$5[addressNumber];
        };
        return MonoMethod;
    }());
    ...
    var MonoClass = /** @class */ (function () {
        ...
        MonoClass.fromAddress = function (address) {
            if (address.isNull())
                return null;
            var addressNumber = address.toInt32();
            if (cache$6[addressNumber] === undefined) {
                cache$6[addressNumber] = new MonoClass({ address: address });
            }
            return cache$6[addressNumber];
        };
        return MonoClass;
    }());
    ...
    (function (MonoMetaTableEnum) {
        ...
        MonoMetaTableEnum[MonoMetaTableEnum["MONO_TABLE_MEMBERREF"] = 10] = "MONO_TABLE_MEMBERREF";
        ...
        MonoMetaTableEnum[MonoMetaTableEnum["MONO_TABLE_FIELDLAYOUT"] = 16] = "MONO_TABLE_FIELDLAYOUT";
        ...
        MonoMetaTableEnum[MonoMetaTableEnum["MONO_TABLE_MODULEREFa"] = 26] = "MONO_TABLE_MODULEREFa";
        ...
        MonoMetaTableEnum[MonoMetaTableEnum["MONO_TABLE_ASSEMBLY"] = 32] = "MONO_TABLE_ASSEMBLY";
        ...
        MonoMetaTableEnum[MonoMetaTableEnum["MONO_TABLE_GENERICPARAMa"] = 42] = "MONO_TABLE_GENERICPARAMa";
    ...
    var tableInfo = assemblyCSharp.getTableInfo(MonoMetaTableEnum.MONO_TABLE_TYPEDEF);
